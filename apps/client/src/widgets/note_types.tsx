 ...
 */
export type ExtendedNoteType = Exclude<NoteType, "launcher" | "text" | "code"> | "empty" | "readOnlyCode" | "readOnlyText" | "editableText" | "editableCode" | "attachmentDetail" | "attachmentList" |  "protectedSession" | "aiChat" | "decantWorkspace";
...
export const TYPE_MAPPINGS: Record<ExtendedNoteType, NoteTypeMapping> = {
    ...
    decantWorkspace: {
        view: () => import("./decant_workspace/DecantWorkspaceWidget"),
        className: "decant-workspace-container",
        isFullHeight: true
    }
};
