 ...
 */
export const extractUrls = asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const checkDuplicates = asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const { urls } = req.body ?? {};
