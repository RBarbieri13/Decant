...
const SAMPLE_TREE_DATA: TreeNodeData[] = [
  {
    ...
    iconType: 'folder',
    children: [
      { id: 'data-models', name: 'Data Models', iconType: 'document' },
      { id: 'api-integration', name: 'API Integration', iconType: 'link' },
      { id: 'user-interface', name: 'User Interface', iconType: 'ui' },
      { id: 'documentation', name: 'Documentation', iconType: 'book' },
      {
        id: 'project-phoenix',
            ...
            children: [
              {
                ...
                iconType: 'folder',
                children: [
                  { id: 'buttons', name: 'Buttons', iconType: 'component' },
                  { id: 'forms', name: 'Forms', iconType: 'component' },
                  { id: 'modals', name: 'Modals', iconType: 'component' },
                ],
              },
              { id: 'layouts', name: 'Layouts', iconType: 'folder' },
              { id: 'styles', name: 'Styles', iconType: 'style' },
              { id: 'assets', name: 'Assets', iconType: 'image' },
            ],
          },
          { id: 'backend', name: 'Backend', iconType: 'folder' },
          { id: 'tests', name: 'Tests', iconType: 'test' },
        ],
      },
    ],
  },
  ...
  { id: 'settings', name: 'Settings', iconType: 'settings' },
  {
    ...
    iconType: 'folder',
    children: [
      { id: 'guidelines', name: 'Guidelines', iconType: 'guidelines' },
      { id: 'brand-assets', name: 'Brand Assets', iconType: 'brand' },
      { id: 'external-tools', name: 'External Tools', iconType: 'tools' },
    ],
  },
  {
    id: 'team-space',
    ...
    iconType: 'folder',
    children: [
      { id: 'members', name: 'Members', iconType: 'person' },
      { id: 'meeting-notes', name: 'Meeting Notes', iconType: 'notes' },
    ],
  },
];
...
const SAMPLE_TABLE_DATA: TableRow[] = [
  ...
  {
    id: 'firebase-auth',
    logo: 'https://www.gstatic.com/devrel-devsite/prod/v1e7f9f51c23e5bfcf9bd8f4c3f0e4f1e5c0e6a1b2c3d4e5f6a7b8c9d0/firebase/images/touchicon-180.png',
    title: 'Firebase Authentication',
    type: 'Auth Service',
    typeSymbol: '🔐',
    segment: 'Backend',
    category: 'Auth Service',
    hierarchy: 'Backend > Auth',
    quickPhrase: 'Secure user login & management',
    tags: [
      { label: 'Auth', color: 'orange' },
      { label: 'Security', color: 'green' },
      { label: 'Google', color: 'blue' },
    ],
    date: '2024-05-20',
    company: 'Google',
    starred: false,
  ...
  },
  {
    ...
    quickPhrase: 'Delightful JavaScript Testing',
    tags: [
      { label: 'Testing', color: 'green' },
      { label: 'Unit', color: 'blue' },
  ...
  },
  {
    ...
    segment: 'Frontend',
    category: 'Framework',
    hierarchy: 'Frontend > Framework',
    quickPhrase: 'One framework mobile & desktop',
    tags: [
      { label: 'Testing', color: 'green' },
      { label: 'Unit', color: 'blue' },
      { label: 'Drogear', color: 'pink' },
    ],
    date: '2024-05-19',
    company: 'OpenJS Foundation',
    starred: false,
  ...
  },
  {
    ...
    segment: 'Frontend',
    category: 'Framework',
    hierarchy: 'Frontend > CSS',
    quickPhrase: 'Utility-first CSS framework',
    tags: [
      { label: 'Testing', color: 'green' },
      { label: 'Unit', color: 'blue' },
      { label: 'Integration', color: 'purple' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Testing', color: 'green' },
      { label: 'Iintegration', color: 'purple' },
    ],
    date: '2024-05-19',
    company: 'Google',
    starred: false,
  ...
  },
  {
    ...
    segment: 'Frontend',
    category: 'Auth Service',
    hierarchy: 'Frontend > Auth',
    quickPhrase: 'Secure user login & management',
    tags: [
      { label: 'Auth', color: 'purple' },
      { label: 'Ooik', color: 'yellow' },
    ],
    date: '2024-05-20',
    company: 'Meta',
    starred: false,
  ...
  },
  {
    ...
    quickPhrase: 'Utility-first CSS framework',
    tags: [
      { label: 'Utility-Orst', color: 'purple' },
    ],
    date: '2024-05-19',
    company: 'Tailwind Labs',
    starred: false,
